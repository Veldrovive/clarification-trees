...
class DialogNode:
    node_type_to_str = {
        NodeType.ROOT: "user",
        NodeType.CLARIFICATION_QUESTION: "agent",
        NodeType.CLARIFYING_ANSWER: "user",
        NodeType.INFERENCE: "answer"
    }
...
class DialogTree:
    ...
    def __init__(self, init_question: str, init_image: Image.Image, gold_answer: str, answers: List[str]):
